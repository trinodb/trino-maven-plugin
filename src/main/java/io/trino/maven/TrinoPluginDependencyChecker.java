        ...
        extends BaseTrinoPluginMojo
{
            ...
            throws MojoExecutionException
    {
        ...
        Set<String> spiDependencies = spiDependencies(aetherArtifact(getSpiDependency()));
    ...
    {
        return isSpiArtifact(artifact.getGroupId(), artifact.getArtifactId(), artifact.getType(), artifact.getClassifier());
    }
}
